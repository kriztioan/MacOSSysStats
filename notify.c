...
id fakeBundleIdentifierIMP(id self, SEL _cmd) {
  if (self == ((id (*)(id, SEL))objc_msgSend)((id)NSBundle, mainBundle))
    return (id)CFSTR("com.kriztioan.notify");
  else
    return ((id (*)(id, SEL))objc_msgSend)(self, fakeBundleIdentifier);
}
...
void init_notify() {
  ...
  method_exchangeImplementations(
      class_getInstanceMethod(NSBundle, bundleIdentifier),
...
void notify(const char *title, const char *subtitle, const char *message,
  ...
  id notification = ((id (*)(id, SEL))objc_msgSend)(
      ((id (*)(id, SEL))objc_msgSend)((id)NSUserNotification,
  ...
  ((void (*)(id, SEL, CFStringRef))objc_msgSend)(
      notification, sel_registerName("setTitle:"), cfTitle);

  CFRelease(cfTitle);

  if (subtitle != NULL) {

    CFStringRef cfSubtitle =
        CFStringCreateWithCString(NULL, subtitle, kCFStringEncodingUTF8);

    ((void (*)(id, SEL, CFStringRef))objc_msgSend)(
        notification, sel_registerName("setSubtitle:"), cfSubtitle);
  ...
  ((void (*)(id, SEL, CFStringRef))objc_msgSend)(
      notification, sel_registerName("setInformativeText:"), cfMessage);

  CFRelease(cfMessage);

  id userNotificationCenter = ((id (*)(id, SEL))objc_msgSend)(
      (id)NSUserNotificationCenter,
      sel_registerName("defaultUserNotificationCenter"));

  ((void (*)(id, SEL, id))objc_msgSend)(
      userNotificationCenter, sel_registerName("deliverNotification:"),
      notification);

  ((void (*)(id, SEL))objc_msgSend)(notification, sel_registerName("release"));
